 ...
 * $uploader = new IscrittiMediaUploader('/home/xoops/uploads', $allowedMimeTypes, $maxFileSize, $maxFileWidth, $maxFileHeight);
...
class mediaUploader extends \XoopsMediaUploader
{
    ...
    // should be private, but is public because IscrittiMediaUploader extends XoopsMediaUploader
    {
        $matched = array();
